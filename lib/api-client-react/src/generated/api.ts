...
export const submitOnboardingRequest = async (
  onboardingRequestBody: OnboardingRequestBody,
  options?: RequestInit,
  ...
  return customFetch<OnboardingRequest>(getSubmitOnboardingRequestUrl(), {
    ...
    body: JSON.stringify(onboardingRequestBody),
  });
};

export const getSubmitOnboardingRequestMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
...
export type SubmitOnboardingRequestMutationResult = NonNullable<
  Awaited<ReturnType<typeof submitOnboardingRequest>>
>;
export type SubmitOnboardingRequestMutationBody =
  BodyType<OnboardingRequestBody>;
export type SubmitOnboardingRequestMutationError = ErrorType<unknown>;

/**
 * @summary Submit a new tenant onboarding request
 */
export const useSubmitOnboardingRequest = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
 ...
 */
export const getListOnboardingRequestsUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/api/onboarding/requests?${stringifiedParams}`
...
export const listOnboardingRequests = async (
  params?: ListOnboardingRequestsParams,
  options?: RequestInit,
): Promise<OnboardingRequestListResponse> => {
  return customFetch<OnboardingRequestListResponse>(
    getListOnboardingRequestsUrl(params),
    {
      ...options,
      method: "GET",
    },
...
export const getListOnboardingRequestsQueryKey = (
  params?: ListOnboardingRequestsParams,
) => {
  return [`/api/onboarding/requests`, ...(params ? [params] : [])] as const;
};

export const getListOnboardingRequestsQueryOptions = <
  TData = Awaited<ReturnType<typeof listOnboardingRequests>>,
  TError = ErrorType<unknown>,
>(
  params?: ListOnboardingRequestsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listOnboardingRequests>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListOnboardingRequestsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listOnboardingRequests>>
  > = ({ signal }) =>
    listOnboardingRequests(params, { signal, ...requestOptions });
...
export type ListOnboardingRequestsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listOnboardingRequests>>
>;
...
export function useListOnboardingRequests<
  TData = Awaited<ReturnType<typeof listOnboardingRequests>>,
  TError = ErrorType<unknown>,
>(
  params?: ListOnboardingRequestsParams,
...
export const getGetOnboardingRequestQueryKey = (id: number) => {
  return [`/api/onboarding/requests/${id}`] as const;
};

export const getGetOnboardingRequestQueryOptions = <
  TData = Awaited<ReturnType<typeof getOnboardingRequest>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getOnboardingRequest>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetOnboardingRequestQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getOnboardingRequest>>
  > = ({ signal }) => getOnboardingRequest(id, { signal, ...requestOptions });
...
export type GetOnboardingRequestQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOnboardingRequest>>
>;
...
export function useGetOnboardingRequest<
  TData = Awaited<ReturnType<typeof getOnboardingRequest>>,
  TError = ErrorType<unknown>,
>(
  id: number,
...
export const updateOnboardingRequest = async (
  id: number,
  updateOnboardingRequestBody: UpdateOnboardingRequestBody,
  options?: RequestInit,
): Promise<OnboardingRequest> => {
  return customFetch<OnboardingRequest>(getUpdateOnboardingRequestUrl(id), {
    ...
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(updateOnboardingRequestBody),
  });
};

export const getUpdateOnboardingRequestMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateOnboardingRequestMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateOnboardingRequest>>
>;
export type UpdateOnboardingRequestMutationBody =
  BodyType<UpdateOnboardingRequestBody>;
...
>(options?: {
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listCatalogCategories>>
  > = ({ signal }) => listCatalogCategories({ signal, ...requestOptions });
...
export const aiConciergeChat = async (
...
export const getAiConciergeChatMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AiConciergeChatMutationResult = NonNullable<
  Awaited<ReturnType<typeof aiConciergeChat>>
>;
 ...
 * @summary Send a message to the AI sales concierge
 */
export const useAiConciergeChat = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const aiUpsellSuggestions = async (
  aiUpsellBody: AiUpsellBody,
  options?: RequestInit,
  ...
  return customFetch<AiUpsellResponse>(getAiUpsellSuggestionsUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(aiUpsellBody),
  });
};

export const getAiUpsellSuggestionsMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AiUpsellSuggestionsMutationResult = NonNullable<
  Awaited<ReturnType<typeof aiUpsellSuggestions>>
>;
 ...
 * @summary Get AI upsell suggestions based on current cart or order
 */
export const useAiUpsellSuggestions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const tokenizePayment = async (
  tokenizePaymentBody: TokenizePaymentBody,
  options?: RequestInit,
): Promise<TokenizePaymentResponse> => {
  return customFetch<TokenizePaymentResponse>(getTokenizePaymentUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(tokenizePaymentBody),
  });
};

export const getTokenizePaymentMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type TokenizePaymentMutationResult = NonNullable<
  Awaited<ReturnType<typeof tokenizePayment>>
>;
 ...
 * @summary Create a payment token for an order (returns client secret for card element)
 */
export const useTokenizePayment = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getGetOrderNotesQueryKey = (id: number) => {
  return [`/api/orders/${id}/notes`] as const;
};

export const getGetOrderNotesQueryOptions = <
  TData = Awaited<ReturnType<typeof getOrderNotes>>,
  TError = ErrorType<unknown>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getOrderNotes>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getOrderNotes>>> = ({
    signal,
  }) => getOrderNotes(id, { signal, ...requestOptions });
...
export type GetOrderNotesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOrderNotes>>
>;
...
export const addOrderNote = async (
  id: number,
  addOrderNoteBody: AddOrderNoteBody,
  options?: RequestInit,
): Promise<OrderNote> => {
  return customFetch<OrderNote>(getAddOrderNoteUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(addOrderNoteBody),
  });
};

export const getAddOrderNoteMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AddOrderNoteMutationResult = NonNullable<
  Awaited<ReturnType<typeof addOrderNote>>
>;

...
const DEFAULT_STEPS: IntroStep[] = [
  { emoji: "⚡", title: "Hey! I'm Zappy", body: "Your personal shopping buddy for the tenant catalogue. No judgment, no awkwardness — just help finding what you need.", cta: "Let's go!" },
